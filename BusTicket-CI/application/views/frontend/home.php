				...
				<div class="row fullscreen d-flex align-items-center justify-content-end">
					<div class="banner-content col-lg-7 col-md-12">
						<!-- <h4  class="combined">Official Ticket Guarantee</h4> -->
							<h2 class="text-white" >
						Sistem Pesan Tiket Bus		
						</h2>
						<p class="text-white" >
						Sekarang mencari tiket bus lebih mudah, Anda dapat memesan secara online di BTBS. Tidak perlu repot ke terminal atau kantor agen, sekarang Anda dapat membeli tiket dengan mudah. Pemesanan Cepat dan Mudah. Bebas Memilih Kursi. Harga Termurah Setiap Hari. Layanan Pelanggan 24/7. Semua Kelas dan Rute.						</p>
			...
			<div class="container">
				<div class="row d-flex justify-content-center">
					<div class="col-md-8 pb-40 header-text">
						<h1>LANGKAH-LANGKAH PESAN TIKET BUS</h1>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-service">
							...
							<h4>Pilih Bus dan Kursi</h4>
							<p>
							Pilih bus, kursi, tempat keberangkatan, tujuan, isi detail penumpang lalu klik 'Bayar'
							</p>
						</div>
					</div>
					<!-- Log on to codeastro.com for more projects -->
