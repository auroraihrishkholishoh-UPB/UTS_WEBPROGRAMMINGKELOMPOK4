				...
				<div class="container">
					<div class="row">
						<div class="col-lg-3  col-md-6 col-sm-6">
							...
							<h4 class="text-white">Pesan Tiket Bus</h4>
							<p>
							BUS Tickets adalah layanan pemesanan tiket bus online terbesar di dunia. Dipercaya oleh lebih dari 8 juta pelanggan di seluruh dunia. Bus Tickets menawarkan pemesanan tiket bus melalui website.
								</p>
							</div>
						</div>
						...
						<div class="col-lg-5  col-md-6 col-sm-6">
							...
							<p>Anda dapat mempercayai kami. kami hanya mengirim penawaran, bukan spam.</p>
            ...
            <p class="footer-text m-0"><span>&copy; <?= date('Y') ?> Bus Ticket Booking System - Developed by kelompok 4 UPB </span> </p>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
