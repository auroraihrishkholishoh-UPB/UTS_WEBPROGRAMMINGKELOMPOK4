							...
							<div class="card mb-5">
								...
								<div class="card-body">
									<div class="form-group">
										...
										<input type="text" id="" class="form-control" id="" name="nama[]" placeholder="Nomor Kursi <?php echo $row ?> Atas Nama" required>
							...
							<div class="card mb-5">
								...
								<div class="card-body">
									<div class='form-group'>
										...
										<div class='form-group'>
											<div class='col-sm-12'>
												<input name='nama_pemesan' required="" maxlength='64' class='form-control required' placeholder='Nama Pelanggan' type='text' title='Nama pelanggan diperlukan' value="<?php echo $this->session->userdata('nama_lengkap') ?>"></div>
											</div>
											<div class='form-group'>
												<div class='col-sm-12'>
													<input name='hp' required="" maxlength='16' class='form-control required' placeholder='Nomor Handphone' type='text' title='Kolom Wajib Diisi' value="<?php echo $this->session->userdata('telpon') ?>"></div>
												</div>
												<div class='form-group'>
													<div class='col-sm-12'>
													<textarea name='alamat' cols='20' rows='3' id='alamat' required="" maxlength='256' class='form-control required' placeholder='Alamat' title='Alamat Wajib Diisi.' ><?php echo $this->session->userdata('alamat')?></textarea></div>
												</div>
												<div class='form-group'>
													<div class='col-sm-12'>
										...
										<div class="col">
											<div class="card">
												<div class="card-header">
													<i class="fas fa-dollar-sign"></i> Metode Pembayaran
												</div>
												<div class="card-body">
