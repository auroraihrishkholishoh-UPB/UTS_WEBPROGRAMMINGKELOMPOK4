		...
		<section class="generic-banner relative">
			<div class="container">
				<div class="section-top-border">
					<h3 class="mb-30" align="center">Profil Saya</h3>
								...
								<div class="card-body" align="left">
									<div class="row">
										...
										<div class="col-sm-14">
											...
											<p><a href="<?php echo base_url('profile/changepassword/'.$profile['kd_pelanggan']) ?>" class="btn btn-primary">Ganti Kata Sandi</a></p>
