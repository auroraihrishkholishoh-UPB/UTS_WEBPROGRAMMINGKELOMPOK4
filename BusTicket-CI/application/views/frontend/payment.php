					...
					<div class="col-lg-10">
						...
						<div class="card">
							...
							<div class="card-body" align="center">
								<h4>Silakan Selesaikan Pembayaran Anda Sekarang!</h4><br>
								...
								<div class="offset-lg-1 col-lg-10 offset-sm-0 col-sm-12">
									<div class="row">
										...
										<div class="col-md-3 copy-link">
											<button onclick="myFunction()" class="btn btn-outline-primary"><i class="fas fa-copy"></i> Salin Nomor Rekening</button>
										</div>
									</div>
								</div>
								<div class="col-12 medium-title regular-text mt-20">
									<h4><b> <p>Total Pembayaran</p></b></h4>
								</div>
									...
									<div class="col-md-8 mt-sm-30">
										...
										<div class="">
											<ol class="ordered-list" align="left">
												...
												<li>Pilih menu Transfer dan Ke Rekening <?= $tiket[0]['nama_bank']; ?></li>
												<li>Masukkan nomor rekening <?= $tiket[0]['nama_bank']; ?> tujuan</li>
												<li>Masukkan nominal uang yang akan ditransfer</li>
												<li>Layar ATM akan menampilkan data transaksi Anda,</li>
												<li>Jika data benar pilih "YA" (OK)</li>
