						...
						<div class="card-body">
							<div class="alert alert-warning" role="alert">
								...
								<P>Sebelum Membeli Tiket, Silakan lihat>> <b><i data-toggle="modal"
											data-target="#exampleModal">Bagaimana cara memesan?</i></b></P>
							</div>
							<form action="<?php echo base_url() ?>tiket/cekjadwal?>" method="get">
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Asal Perjalanan</label>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Cara memesan tiket?</h5>
			...
			<div class="modal-body">
				<div class="table-responsive">
					...
					<li>Pilih tanggal dan pilih terminal/kota asal dan tujuan Anda untuk mencari jadwal yang tersedia.
							<li>Cari tiket kemudian klik tombol <b>Pilih</b> pada tiket yang ingin Anda pesan.
							</li>
							...
							<li>Isi detail tiket dengan memberikan detail pelanggan seperti Nama Penumpang, Usia dan identitas pelanggan lainnya yang diperlukan. Dengan itu, pilih salah satu bank yang tersedia [sebagai Metode Pembayaran] untuk memesan tiket.</li>
							<li>Setelah mengirimkan formulir, pemesanan dilakukan <b>[sementara]</b>. Sistem akan memberikan <b>QR Code</b> dan Anda harus melakukan pembayaran.</li>
							...
							<li>Anda juga akan menerima <b>E-Tiket</b> setelah pembayaran diverifikasi. </li>
							<li>Jika Anda telah melakukan pembayaran, bawa bukti pembayaran pada saat keberangkatan dan tukar satu jam sebelum keberangkatan. </li>
						</span></ol>
