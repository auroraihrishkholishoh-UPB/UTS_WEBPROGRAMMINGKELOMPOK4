					...
					<div class="col-lg-8">
						...
						<div class="card ">
							<div class="card-header">
								<i class="fas fa-user"></i> Pendaftaran Pelanggan
							</div>
							<div class="card-body">
								<form action="<?php echo base_url() ?>login/daftar" method="post">
									...
									<div class="form-group">
										<div class="form-row">
											...
											<div class="col-md-6">
												<div class="form-label-group">
													<input type="number" id="nomor" name="nomor" class="form-control" required="" placeholder="Nomor Telepon" value="<?php echo set_value('nomor') ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="password" class="form-control form-control-user" name="password2" placeholder="Ulangi Kata Sandi">
										</div>
									</div>
								...
								<div class="text-center">
									<p>Sudah Terdaftar? <a class="" href="<?php echo base_url() ?>login">Login Sekarang</a></p>
								</div>
							</div>
						</div>
					</div>
