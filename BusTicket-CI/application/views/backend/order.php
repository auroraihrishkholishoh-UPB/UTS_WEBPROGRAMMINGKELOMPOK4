  ...
  <body id="page-top">
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <h1 class="h5 text-gray-800">Daftar Pemesanan</h1>
        </div>
        <div class="card-body">
                ...
                <?php $i=1;foreach ($order as $row) { ?>
                  <tr>
                    ...
                    <?php if ($row['status_order'] == '1') { ?>
                          <td class="btn-danger"> Belum Dibayar</td> 
                          <?php } elseif($row['status_order'] == '2') { ?>
                          <td class="btn-success"> Sudah Dibayar</td>
                        <?php } else { ?>
                          <td class="btn-warning"> Dibatalkan</td>
                          <?php } ?>
                    <td><a href="<?= base_url('backend/order/vieworder/'.$row['kd_order']) ?>" class="btn btn btn-info">Lihat</a></td>
                  </tr>
                <?php } ?>
            </tbody>
          </table>
