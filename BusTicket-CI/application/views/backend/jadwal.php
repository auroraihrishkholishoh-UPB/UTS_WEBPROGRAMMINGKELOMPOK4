...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="container-fluid">
      <h1 class="h5 text-gray-800">Manajemen Jadwal</h1>
      <!-- DataTales Example -->
            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="<?= base_url('backend/jadwal/viewjadwal/'.$row['kd_jadwal']) ?>" class="btn btn-info">Lihat</a>
                    <a href="<?= base_url('backend/jadwal/deletejadwal/'.$row['kd_jadwal']) ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin menghapus jadwal ini?')">Hapus</a>
                  </td>
                </td>
              </tr>
              <?php } ?>
