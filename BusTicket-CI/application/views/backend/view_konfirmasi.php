    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Kode Pemesanan [<?= $konfirmasi[0]['kd_order']; ?>]  </h6>
        </div>
        <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="tgl_beli" value="Rp <?= number_format($row['total_konfirmasi'],0,',','.'); ?>" readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                    <label for="" class="col-sm-4 control-label">Bukti Pembayaran</label>
                    <div class="col-sm-8">
