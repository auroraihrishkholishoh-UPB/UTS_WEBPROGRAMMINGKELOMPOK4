...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="container-fluid">
      <h1 class="h5 text-gray-800">Manajemen Tujuan/Terminal</h1>
      <!-- DataTales Example -->
            ...
            <thead class="thead-dark">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center"><a href="<?= base_url('backend/rute/viewrute/'.$row['kd_tujuan']) ?>" class="btn btn-info">Lihat</a>
                    <a href="<?= base_url('backend/rute/deletetujuan/'.$row['kd_tujuan']) ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin menghapus tujuan ini?')">Hapus</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
